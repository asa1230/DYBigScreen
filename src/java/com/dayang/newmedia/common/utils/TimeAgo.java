...
public class TimeAgo {
    ...
    /**
     * 指挥调度时间显示，分钟、小时、天、5天之后年月日
     * @param date
     * @return
     */
    public static String newsCommandToDay(Date date,Date nowDate){
    ...
    public static void main(String[] args) throws ParseException {
        String deadline = "2015-12-30 12:45:59";
        Date date = new Date();
        SimpleDateFormat simple = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        date = simple.parse(deadline);
       // System.out.println(TimeAgo.fromDeadline(date));
 
        String before = "2015-06-17 18:45:59";
        date = simple.parse(before);
        //System.out.println(TimeAgo.fromToday(date));
        System.out.println(TimeAgo.newsCommandToDay(date, new Date()));
       // System.out.println(TimeAgo.getFullDate());
       // System.out.println(TimeAgo.getDate());
    }
