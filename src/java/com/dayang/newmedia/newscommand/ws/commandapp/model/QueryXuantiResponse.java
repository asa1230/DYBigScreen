...
public class QueryXuantiResponse   {
   ...
   * 通用返回
   **/
  public QueryXuantiResponse commonResponse(CommonResponse commonResponse) {
   ...
   * 总条目数
   **/
  public QueryXuantiResponse totalCount(Integer totalCount) {
   ...
   * 当前页
   **/
  public QueryXuantiResponse currentPage(Integer currentPage) {
   ...
   * 每页条目数
   **/
  public QueryXuantiResponse limit(Integer limit) {
    this.limit = limit;
    return this;
  }
   ...
   * 线索
   **/
  public QueryXuantiResponse records(List<NewsTask> records) {
  ...
  public boolean equals(Object o) {
    ...
    QueryXuantiResponse queryXuantiResponse = (QueryXuantiResponse) o;
