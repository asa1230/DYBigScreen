...
public class MREMLMREMLRequestEntityRequestExtendMSGQueryRequestAdvanceCondtion  implements java.io.Serializable {
    ...
    private MREML_pkg.MREMLMREMLRequestEntityRequestExtendMSGQueryRequestAdvanceCondtionAttributeCondition[] attributeCondition;
    ...
    public MREMLMREMLRequestEntityRequestExtendMSGQueryRequestAdvanceCondtion(
           ...
           MREML_pkg.MREMLMREMLRequestEntityRequestExtendMSGQueryRequestAdvanceCondtionAttributeCondition[] attributeCondition,
     ...
     */
    public MREML_pkg.MREMLMREMLRequestEntityRequestExtendMSGQueryRequestAdvanceCondtionAttributeCondition[] getAttributeCondition() {
        return attributeCondition;
    }
     ...
     */
    public void setAttributeCondition(MREML_pkg.MREMLMREMLRequestEntityRequestExtendMSGQueryRequestAdvanceCondtionAttributeCondition[] attributeCondition) {
        this.attributeCondition = attributeCondition;
    }

    public MREML_pkg.MREMLMREMLRequestEntityRequestExtendMSGQueryRequestAdvanceCondtionAttributeCondition getAttributeCondition(int i) {
        return this.attributeCondition[i];
    }

    public void setAttributeCondition(int i, MREML_pkg.MREMLMREMLRequestEntityRequestExtendMSGQueryRequestAdvanceCondtionAttributeCondition _value) {
