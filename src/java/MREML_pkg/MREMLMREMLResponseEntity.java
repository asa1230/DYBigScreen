...
public class MREMLMREMLResponseEntity  implements java.io.Serializable {
    ...
    private MREML_pkg.MREMLMREMLResponseEntityResourceStatus[] resourceStatus;

    private MREML_pkg.MREMLMREMLResponseEntityResponseExtendMSG responseExtendMSG;
    ...
    public MREMLMREMLResponseEntity(
           ...
           MREML_pkg.MREMLMREMLResponseEntityResourceStatus[] resourceStatus,
           MREML_pkg.MREMLMREMLResponseEntityResponseExtendMSG responseExtendMSG,
     ...
     */
    public MREML_pkg.MREMLMREMLResponseEntityResourceStatus[] getResourceStatus() {
        return resourceStatus;
    }
     ...
     */
    public void setResourceStatus(MREML_pkg.MREMLMREMLResponseEntityResourceStatus[] resourceStatus) {
        this.resourceStatus = resourceStatus;
    }

    public MREML_pkg.MREMLMREMLResponseEntityResourceStatus getResourceStatus(int i) {
        return this.resourceStatus[i];
    }

    public void setResourceStatus(int i, MREML_pkg.MREMLMREMLResponseEntityResourceStatus _value) {
     ...
     */
    public MREML_pkg.MREMLMREMLResponseEntityResponseExtendMSG getResponseExtendMSG() {
        return responseExtendMSG;
    }
     ...
     */
    public void setResponseExtendMSG(MREML_pkg.MREMLMREMLResponseEntityResponseExtendMSG responseExtendMSG) {
        this.responseExtendMSG = responseExtendMSG;
    }
