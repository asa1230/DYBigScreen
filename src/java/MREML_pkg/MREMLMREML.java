...
public class MREMLMREML  implements java.io.Serializable {
    private MREML_pkg.MREMLMREMLEnvelopEntity envelopEntity;

    private MREML_pkg.MREMLMREMLEMIEntity EMIEntity;

    private MREML_pkg.ResourceEntity[] resourceEntity;

    private MREML_pkg.BroadcastListEntity[] broadcastListEntity;

    private MREML_pkg.NewsListEntity[] newsListEntity;

    private MREML_pkg.MREMLMREMLRequestEntity requestEntity;

    private MREML_pkg.MREMLMREMLResponseEntity responseEntity;

    private MREML_pkg.MREMLMREMLNotifyEntity notifyEntity;

    public MREMLMREML() {
    }

    public MREMLMREML(
           MREML_pkg.MREMLMREMLEnvelopEntity envelopEntity,
           MREML_pkg.MREMLMREMLEMIEntity EMIEntity,
           MREML_pkg.ResourceEntity[] resourceEntity,
           MREML_pkg.BroadcastListEntity[] broadcastListEntity,
           MREML_pkg.NewsListEntity[] newsListEntity,
           MREML_pkg.MREMLMREMLRequestEntity requestEntity,
           MREML_pkg.MREMLMREMLResponseEntity responseEntity,
           MREML_pkg.MREMLMREMLNotifyEntity notifyEntity) {
     ...
     */
    public MREML_pkg.MREMLMREMLEnvelopEntity getEnvelopEntity() {
        return envelopEntity;
    }
     ...
     * @param envelopEntity
     */
    public void setEnvelopEntity(MREML_pkg.MREMLMREMLEnvelopEntity envelopEntity) {
        this.envelopEntity = envelopEntity;
    }
     ...
     * @return EMIEntity
     */
    public MREML_pkg.MREMLMREMLEMIEntity getEMIEntity() {
        return EMIEntity;
    }
     ...
     * @param EMIEntity
     */
    public void setEMIEntity(MREML_pkg.MREMLMREMLEMIEntity EMIEntity) {
        this.EMIEntity = EMIEntity;
    }
     ...
     */
    public MREML_pkg.ResourceEntity[] getResourceEntity() {
        return resourceEntity;
    }
     ...
     */
    public void setResourceEntity(MREML_pkg.ResourceEntity[] resourceEntity) {
        this.resourceEntity = resourceEntity;
    }

    public MREML_pkg.ResourceEntity getResourceEntity(int i) {
        return this.resourceEntity[i];
    }

    public void setResourceEntity(int i, MREML_pkg.ResourceEntity _value) {
     ...
     */
    public MREML_pkg.BroadcastListEntity[] getBroadcastListEntity() {
        return broadcastListEntity;
    }
     ...
     */
    public void setBroadcastListEntity(MREML_pkg.BroadcastListEntity[] broadcastListEntity) {
        this.broadcastListEntity = broadcastListEntity;
    }

    public MREML_pkg.BroadcastListEntity getBroadcastListEntity(int i) {
        return this.broadcastListEntity[i];
    }

    public void setBroadcastListEntity(int i, MREML_pkg.BroadcastListEntity _value) {
     ...
     */
    public MREML_pkg.NewsListEntity[] getNewsListEntity() {
        return newsListEntity;
    }
     ...
     */
    public void setNewsListEntity(MREML_pkg.NewsListEntity[] newsListEntity) {
        this.newsListEntity = newsListEntity;
    }

    public MREML_pkg.NewsListEntity getNewsListEntity(int i) {
        return this.newsListEntity[i];
    }

    public void setNewsListEntity(int i, MREML_pkg.NewsListEntity _value) {
     ...
     */
    public MREML_pkg.MREMLMREMLRequestEntity getRequestEntity() {
        return requestEntity;
    }
     ...
     * @param requestEntity
     */
    public void setRequestEntity(MREML_pkg.MREMLMREMLRequestEntity requestEntity) {
        this.requestEntity = requestEntity;
    }
     ...
     */
    public MREML_pkg.MREMLMREMLResponseEntity getResponseEntity() {
        return responseEntity;
    }
     ...
     */
    public void setResponseEntity(MREML_pkg.MREMLMREMLResponseEntity responseEntity) {
        this.responseEntity = responseEntity;
    }
     ...
     * @return notifyEntity
     */
    public MREML_pkg.MREMLMREMLNotifyEntity getNotifyEntity() {
        return notifyEntity;
    }
     ...
     * @param notifyEntity
     */
    public void setNotifyEntity(MREML_pkg.MREMLMREMLNotifyEntity notifyEntity) {
        this.notifyEntity = notifyEntity;
    }
