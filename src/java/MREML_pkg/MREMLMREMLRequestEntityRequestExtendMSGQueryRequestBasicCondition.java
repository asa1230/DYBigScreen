...
public class MREMLMREMLRequestEntityRequestExtendMSGQueryRequestBasicCondition  implements java.io.Serializable {
    ...
    private MREML_pkg.MREMLMREMLRequestEntityRequestExtendMSGQueryRequestBasicConditionTitle title;
    ...
    public MREMLMREMLRequestEntityRequestExtendMSGQueryRequestBasicCondition(
           ...
           MREML_pkg.MREMLMREMLRequestEntityRequestExtendMSGQueryRequestBasicConditionTitle title) {
     ...
     * @return title
     */
    public MREML_pkg.MREMLMREMLRequestEntityRequestExtendMSGQueryRequestBasicConditionTitle getTitle() {
        return title;
    }
     ...
     * @param title
     */
    public void setTitle(MREML_pkg.MREMLMREMLRequestEntityRequestExtendMSGQueryRequestBasicConditionTitle title) {
        this.title = title;
    }
