...
public class MREMLMREMLRequestEntityRequestExtendMSGQueryRequest  implements java.io.Serializable {
    private MREML_pkg.MREMLMREMLRequestEntityRequestExtendMSGQueryRequestBasicCondition basicCondition;

    private MREML_pkg.MREMLMREMLRequestEntityRequestExtendMSGQueryRequestAdvanceCondtion advanceCondtion;

    private java.lang.String orderBy;

    private MREML_pkg.MREMLMREMLRequestEntityRequestExtendMSGQueryRequestLimitation limitation;

    public MREMLMREMLRequestEntityRequestExtendMSGQueryRequest() {
    }

    public MREMLMREMLRequestEntityRequestExtendMSGQueryRequest(
           MREML_pkg.MREMLMREMLRequestEntityRequestExtendMSGQueryRequestBasicCondition basicCondition,
           MREML_pkg.MREMLMREMLRequestEntityRequestExtendMSGQueryRequestAdvanceCondtion advanceCondtion,
           java.lang.String orderBy,
           MREML_pkg.MREMLMREMLRequestEntityRequestExtendMSGQueryRequestLimitation limitation) {
     ...
     */
    public MREML_pkg.MREMLMREMLRequestEntityRequestExtendMSGQueryRequestBasicCondition getBasicCondition() {
        return basicCondition;
    }
     ...
     */
    public void setBasicCondition(MREML_pkg.MREMLMREMLRequestEntityRequestExtendMSGQueryRequestBasicCondition basicCondition) {
        this.basicCondition = basicCondition;
    }
     ...
     */
    public MREML_pkg.MREMLMREMLRequestEntityRequestExtendMSGQueryRequestAdvanceCondtion getAdvanceCondtion() {
        return advanceCondtion;
    }
     ...
     */
    public void setAdvanceCondtion(MREML_pkg.MREMLMREMLRequestEntityRequestExtendMSGQueryRequestAdvanceCondtion advanceCondtion) {
        this.advanceCondtion = advanceCondtion;
    }
     ...
     * @return limitation
     */
    public MREML_pkg.MREMLMREMLRequestEntityRequestExtendMSGQueryRequestLimitation getLimitation() {
        return limitation;
    }
     ...
     * @param limitation
     */
    public void setLimitation(MREML_pkg.MREMLMREMLRequestEntityRequestExtendMSGQueryRequestLimitation limitation) {
        this.limitation = limitation;
    }
