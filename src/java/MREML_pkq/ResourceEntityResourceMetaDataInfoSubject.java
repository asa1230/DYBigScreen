...
public class ResourceEntityResourceMetaDataInfoSubject  implements java.io.Serializable {
    /* 分类 */
    private MREML_pkq.ResourceEntityResourceMetaDataInfoSubjectClass[] _class;
    ...
    public ResourceEntityResourceMetaDataInfoSubject(
           MREML_pkq.ResourceEntityResourceMetaDataInfoSubjectClass[] _class,
     ...
     * @return _class   * 分类
     */
    public MREML_pkq.ResourceEntityResourceMetaDataInfoSubjectClass[] get_class() {
        return _class;
    }
     ...
     * @param _class   * 分类
     */
    public void set_class(MREML_pkq.ResourceEntityResourceMetaDataInfoSubjectClass[] _class) {
        this._class = _class;
    }

    public MREML_pkq.ResourceEntityResourceMetaDataInfoSubjectClass get_class(int i) {
        return this._class[i];
    }

    public void set_class(int i, MREML_pkq.ResourceEntityResourceMetaDataInfoSubjectClass _value) {
