...
public class MREMLMREMLEnvelopEntity  implements java.io.Serializable {
    ...
    private MREML_pkq.MREMLMREMLEnvelopEntityRouter[] router;
    ...
    public MREMLMREMLEnvelopEntity(
           ...
           MREML_pkq.MREMLMREMLEnvelopEntityRouter[] router,
     ...
     * @return router
     */
    public MREML_pkq.MREMLMREMLEnvelopEntityRouter[] getRouter() {
        return router;
    }
     ...
     * @param router
     */
    public void setRouter(MREML_pkq.MREMLMREMLEnvelopEntityRouter[] router) {
        this.router = router;
    }

    public MREML_pkq.MREMLMREMLEnvelopEntityRouter getRouter(int i) {
        return this.router[i];
    }

    public void setRouter(int i, MREML_pkq.MREMLMREMLEnvelopEntityRouter _value) {
