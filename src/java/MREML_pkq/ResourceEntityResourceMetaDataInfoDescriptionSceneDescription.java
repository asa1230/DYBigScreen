...
public class ResourceEntityResourceMetaDataInfoDescriptionSceneDescription  implements java.io.Serializable {
     ...
     * 
     * @return sceneStartPnt   * 场记对应资源的起始位�?
     */
     ...
     * 
     * @param sceneStartPnt   * 场记对应资源的起始位�?
     */
