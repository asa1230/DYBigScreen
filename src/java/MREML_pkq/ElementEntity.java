...
public class ElementEntity  implements java.io.Serializable {
    /* 元素的元数据信息 */
    private MREML_pkq.ElementEntityElementMetadata elementMetadata;

    private MREML_pkq.FileEntity[] fileEntity;

    public ElementEntity() {
    }

    public ElementEntity(
           MREML_pkq.ElementEntityElementMetadata elementMetadata,
           MREML_pkq.FileEntity[] fileEntity) {
     ...
     * 
     * @return elementMetadata   * 元素的元数据信息
     */
    public MREML_pkq.ElementEntityElementMetadata getElementMetadata() {
     ...
     * 
     * @param elementMetadata   * 元素的元数据信息
     */
    public void setElementMetadata(MREML_pkq.ElementEntityElementMetadata elementMetadata) {
        this.elementMetadata = elementMetadata;
    }
     ...
     * @return fileEntity
     */
    public MREML_pkq.FileEntity[] getFileEntity() {
        return fileEntity;
    }
     ...
     * @param fileEntity
     */
    public void setFileEntity(MREML_pkq.FileEntity[] fileEntity) {
        this.fileEntity = fileEntity;
    }

    public MREML_pkq.FileEntity getFileEntity(int i) {
        return this.fileEntity[i];
    }

    public void setFileEntity(int i, MREML_pkq.FileEntity _value) {
