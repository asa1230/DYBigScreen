...
dp.global = (function($, window, document) {
    return {
        ...
        appPath: "",
        /** portal服务地址 */
        portalPath: "http://10.0.90.2:8080/dyportalserver/",
        //		portalPath : "http://dayang.fast.com:8087/dyportalserver/",
        //		portalPath : "http://100.0.0.61:8888/dyportalserver/",
        propaServerUrl: "http://10.0.90.4:8080/dypropagandaservice/", //宣管服务地址
        comiServerUrl: "http://10.0.90.3:8080/gateway/dycommunicationserver/", //通联服务地址
        /** 租户ID */
        tenantId: "dayang.com",
        /** 默认用户ID */
        userId: "8883",
