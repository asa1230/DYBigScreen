...
function init(){
	...
	time = setInterval(function(){
		...
		if(src == "../../dataImg/7.jpg"){
			$("#p1 img").attr('src','../../dataImg/7-2.jpg');
		}else{
			$("#p1 img").attr('src','../../dataImg/7.jpg');
		}
	},10000);
}
...
websocket.onmessage = function(event) {
	...
	if(msg.type == "refresh" && (msg.content == 7 || msg.content == "all")){
	...
	}else if(msg.type == "publishType1"){
		//清除定时器
		clearInterval(time);
		if(msg.content == "pub1_1"){
			$("#p1 img").attr('src','../../dataImg/7.jpg');
		}else{
			$("#p1 img").attr('src','../../dataImg/7-2.jpg');
		}
